...
| PUT    | `/api/v1/beam-lines/{beam_id}/line-items/{id}/connections`             | Add connections to non-line items        |
...
| PUT    | `/api/v1/items/{id}/connections`               | Add connections to other items or line items      |
